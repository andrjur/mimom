...
export const RELATION_METADATA: { [key: string]: { name: string; description: string; rating: 'excellent' | 'good' | 'neutral' | 'difficult' } } = {
  identical: {
    name: "Тождественные",
    description: "Полное равенство и одинаковость мышления. Вы понимаете друг друга буквально с полуслова, у вас одинаковые сильные и слабые стороны. Однако вместе развиваться сложнее, так как ни один не может компенсировать слабые функции другого.",
    rating: 'good'
  },
  dual: {
    name: "Дуальные",
